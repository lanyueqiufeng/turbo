...
public class ProcessEngineImpl implements ProcessEngine {
    ...
    public DeployFlowResult deployFlow(DeployFlowParam deployFlowParam) {
        return definitionProcessor.deploy(deployFlowParam, Boolean.FALSE);
    }

    @Override
    public DeployFlowResult deployDesignFlow(DeployFlowParam deployFlowParam) {
        return definitionProcessor.deploy(deployFlowParam, Boolean.TRUE);
    }
